...
import {getGameIdentity} from "./gameIdentity.js";
...
//        delete card.deck;
    ...
    function initializeUser() {
        ...
        let id = identity ? identity.playerId : Number(localStorage.getItem("id"));
        if(!id) {
            id = Date.now();
        };
        ...
        clientUser.id = id;
        if(identity && identity.username) clientUser.name = identity.username;
